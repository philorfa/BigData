...
disabled = sys.argv[1]
spark = SparkSession.builder.appName('query1-sql_opt').getOrCreate()
...
df1 = df.load("hdfs://master:9000/project/tripdata.parquet")
df2 = df.load("hdfs://master:9000/project/tripvendors.parquet")
